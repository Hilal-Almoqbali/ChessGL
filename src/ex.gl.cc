...
int main()
{
    ...
    // ------------------------------------
    Shader ourShader("./res/shader/s_1/texture.vs", "./res/shader/s_1/texture.fs"); 
    ...
    unsigned int vertexBuffer, vertexAttrib, EBO;
    ...
    unsigned char *data = stbi_load("res/chess-board.jpg", &width, &height, &nrChannels, 0);
    if (data)
    {
